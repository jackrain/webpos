...
SQLiteInnerAccessor.prototype.insert = function (dataObject, callback) {
    ...
    var sql = this.sqlBuilder.buildInsertSQL(dataObject, self.tablename, self.fields, idAttribute);
...
SQLiteInnerAccessor.prototype.update = function (dataObject, options, callback) {
    var self = this;
    var idAttribute = this.autoIncrement?this.idAttribute :null;
    var sql = self.sqlBuilder.buildSQLUpdateSQL(dataObject, self.tablename, self.fields, options, idAttribute);
    self.execute(sql, function (err, info) {
