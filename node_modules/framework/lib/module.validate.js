...
ModuleValidate.prototype.ValidateModel = function (model, name, callBack) {
    ...
    this.S.eachSeries(keys, this.GetCall(this.SyncValidateAttribute, context), function (err) { if (typeof (callBack) == 'function') { callBack(context.r); } });
    return context.r;
}
//验证指定表单
...
ModuleValidate.prototype.ValidateRules = function (v, rules, ignores, element, callBack, context) {
    ...
    if (this.Q.isObject(rules)) {
        ...
        this.S.eachSeries(keys, this.GetCall(this.SyncValidateRule, v, context), this.GetCall(this.SeriesFinal, callBack, context));
    } else {
        callBack();
    }
}
...
//控制流函数:异步验证指定属性规则
ModuleValidate.prototype.SyncValidateAttribute = function (i, callBack, context) {
...
//控制流函数:异步校验指定规则
ModuleValidate.prototype.SyncValidateRule = function (i, callback, v, context) {
