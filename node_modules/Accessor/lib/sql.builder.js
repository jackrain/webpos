var util = require('util'),
    sqlstrutil = require('./sql.util.js'),
    checkQuestion = require('./check.js');
...
//日志函数
SQLiteSQLBuilder.prototype.logImp = util.log;
//类型检测工具
SQLiteSQLBuilder.prototype.checkQues = checkQuestion;
//创建新增SQL语句
